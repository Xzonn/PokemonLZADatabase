  ...
  return (
    <Fragment key="changelog">
      ...
      <div className="section">
        ...
        <h3>信息收集</h3>
        <p>
          本站使用腾讯分析（TAJS）和百度统计等第三方分析服务来收集访问数据，包括但不限于页面访问量、访问时长、来源渠道等信息。这些数据仅用于改进网站服务质量，不涉及个人隐私信息的收集。
        </p>
        <h3>Cookie 使用</h3>
        <p>
          本站使用 Cookie
          和本地存储（LocalStorage）来保存用户的浏览偏好和设置，如已查看的内容标记等。这些数据仅存储在您的浏览器中，不会上传到服务器。您可以随时通过浏览器设置清除这些数据。
        </p>
        <h3>第三方服务</h3>
        <p>
        ...
        <p>
          本站在中国大陆地区通过腾讯云提供服务，在其他区域通过 Vercel 提供服务。访问本站时，您的 IP
          地址等信息可能会被这些服务提供商记录，具体请参考相关服务商的隐私政策。
        </p>
        <h3>数据安全</h3>
        <p>本站不会主动收集、存储或出售用户的个人信息。本站采用 HTTPS 加密传输，确保数据传输安全。</p>
        <h3>政策变更</h3>
        <p>
          本隐私声明可能会根据法律法规要求或网站运营需要进行更新。重大变更将在网站上公告，建议您定期查看本页面以了解最新信息。
        </p>
      </div>
