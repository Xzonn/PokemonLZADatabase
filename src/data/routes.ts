...
export const NAVIGATION_ITEMS: NavigationItem[] = [
  ...
  { path: "/超级进化一览", label: "超级进化一览", icon: "bag-超级石" },
  ...
  { path: "/异次元密阿雷", label: "异次元密阿雷", icon: "hyperspace" },
    ...
    contents: [
      ...
      },
      {
        ...
        contents: [
          ...
          { path: "/异次元密阿雷", label: "异次元密阿雷", icon: "hoopa" },
          { path: "/h/一般", label: "野生异次元", icon: "hyperspace-wild" },
